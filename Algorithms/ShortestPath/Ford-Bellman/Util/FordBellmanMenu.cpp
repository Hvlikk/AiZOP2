...
#include "FordBellmanMenu.h"
#include "../Struct/GraphListFordBellman.h"
#include "../Struct/GraphMatrixFordBellman.h"
#include <iostream>
#include <cmath>
using namespace std;

void FordBellmanMenu::showMenu() {
    GraphListFordBellman* graphList = nullptr;
    GraphMatrixFordBellman* graphMatrix = nullptr;
    int vertices = 0;
    double density = 0.0;
    int startVertex = 0;
    int endVertex = 0;
        ...
        switch (x) {
            ...
            case 5:
                if (graphList && graphMatrix) {
                    ...
                    graphList->fordBellman(startVertex, endVertex);

                    cout << "\nMST dla reprezentacji macierzowej:\n";
                    graphMatrix->fordBellman(startVertex,endVertex);
                } else {
                    cout << "Graf nie zostal wygenerowany.\n";
                }
                break;
